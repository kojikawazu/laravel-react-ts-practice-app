...
vi.mock('@/Components/ui/input', () => ({
    Input: React.forwardRef(({ onChange, ...props }: any, ref: any) => (
      <input onChange={onChange} ref={ref} {...props} data-testid="file-input" />
    )),
}));
...
vi.mock('@/Components/ui/form', () => ({
    ...
    FormField: ({ render }: any) => render({ field: { onChange: mockOnChange, ref: vi.fn() } }),
...
describe('MailFileInput', () => {
    ...
    it('renders the component correctly', () => {
        render(<MailFileInput control={mockControl} fileInputRef={mockFileInputRef} />);
    ...
    it('handles file selection correctly', () => {
        ...
        expect(mockOnChange).toHaveBeenCalledWith(expect.arrayContaining([expect.any(File)]));
    });
